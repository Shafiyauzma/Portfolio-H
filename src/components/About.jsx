        ...
        <div className="about-content-luxury">
          ...
          <div className="narrative-wrapper-luxury">
            <p className="narrative-p-luxury">
              ...
              Experienced in end-to-end development, API design, and <strong>integrating machine learning models</strong> 
              to enhance user experience and optimize workflows. Strong foundation in <strong>data-driven problem-solving</strong> and 
